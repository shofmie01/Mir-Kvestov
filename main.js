...
// ==================== ДАННЫЕ ====================
const quests = [
    { id: "warpoint", name: "Warpoint", type: "VR-квест", typeEn: "vr", status: "open", rating: 4.8, price: 2500, priceStr: "от 2500₽", desc: "Погружение в виртуальную реальность с полным обзором 360°", duration: "60 минут", fullDesc: "Современный VR-квест, где вы оказываетесь на поле боя будущего. Используйте лазерное оружие, уклоняйтесь от врагов и выполняйте тактические задачи.", basedOn: "Оригинальный сценарий", players: "2-4 человека", difficulty: "Средний", difficultyEn: "medium", image: "фото/warpoint.png", theme: "Фантастика / Военный боевик", story: "2050 год. Корпорации захватили власть, и только вы можете остановить их. Ваша команда — элитный отряд сопротивления. Проникните в секретный комплекс и уничтожьте супероружие, пока не стало слишком поздно.", features: ["Полное VR-погружение", "Тактические сражения", "Реалистичное оружие", "Командная работа"] },
    { id: "maniac", name: "Маньяк-коллекционер", type: "Квест", typeEn: "horror", status: "closed", rating: 4.9, price: 2800, priceStr: "от 2800₽", desc: "Страшный психологический триллер", duration: "70 минут", fullDesc: "Вы оказались в логове безумного коллекционера, который собирает человеческие страхи.", basedOn: "По мотивам фильмов ужасов", players: "2-5 человек", difficulty: "Высокий", difficultyEn: "hard", image: "фото/maniac.png", theme: "Психологический хоррор", story: "Вы просыпаетесь в подвале. Вокруг — странные предметы: куклы, фотографии, дневники. Голос из динамика сообщает: «Вы — новый экспонат моей коллекции. У вас 70 минут, чтобы выбраться, иначе станете частью моей галереи страха».", features: ["Живые актёры", "Психологическое давление", "Неожиданные повороты", "Интерактивные загадки"] },
    { id: "psycho", name: "Психбольница", type: "Квест", typeEn: "horror", status: "closed", rating: 4.7, price: 2600, priceStr: "от 2600₽", desc: "Атмосфера безумия и загадок", duration: "60 минут", fullDesc: "Заброшенная психиатрическая лечебница хранит мрачные тайны.", basedOn: "Вдохновлено классикой хоррора", players: "2-6 человек", difficulty: "Высокий", difficultyEn: "hard", image: "фото/psix.png", theme: "Мистический хоррор", story: "Лечебница «Аркхем» была закрыта после загадочных событий. Но ходят слухи, что доктор Морроу продолжает свои эксперименты. Вы отправляетесь туда, чтобы найти доказательства, но попадаете в ловушку.", features: ["Атмосферный звук", "Спецэффекты", "Ловушки", "Элементы триллера"] },
    { id: "banker", name: "Старый банкир", type: "Квест", typeEn: "logic", status: "closed", rating: 4.5, price: 2400, priceStr: "от 2400₽", desc: "Ограбление века в старинном особняке", duration: "60 минут", fullDesc: "Вы — команда грабителей, проникшая в особняк эксцентричного банкира.", basedOn: "Оригинальный детективный сюжет", players: "2-5 человек", difficulty: "Средний", difficultyEn: "medium", image: "фото/bank.png", theme: "Детектив / Ограбление", story: "Мистер Грей, известный банкир, спрятал своё состояние в сейфе, который охраняется сложнейшими механизмами. Ваша цель — взломать систему и вынести деньги, пока хозяин не вернулся.", features: ["Сложные механические загадки", "Командная работа", "Атмосфера старого особняка"] },
    { id: "amongus", name: "Among Us", type: "Квест-анимация", typeEn: "kids", status: "closed", rating: 4.9, price: 2200, priceStr: "от 2200₽", desc: "Космический детектив для команд", duration: "60 минут", fullDesc: "Интерактивная игра по мотивам популярной видеоигры. Вы — члены экипажа космического корабля.", basedOn: "По игре Among Us", players: "4-8 человек", difficulty: "Лёгкий", difficultyEn: "easy", image: "фото/among.png", theme: "Космический детектив", story: "Вы — экипаж корабля «Скиллд». Ваша миссия — выполнить задания и вернуться на Землю. Но один из вас — предатель. Самозванец будет саботировать системы и устранять членов команды.", features: ["Ролевая игра", "Дедукция", "Командные задания", "Костюмы и декорации"] },
    { id: "sherlock", name: "Шерлок Холмс", type: "Квест-анимация", typeEn: "logic", status: "closed", rating: 4.6, price: 2700, priceStr: "от 2700₽", desc: "Лондонские тайны и дедукция", duration: "70 минут", fullDesc: "Викторианский Лондон. Вместе с доктором Ватсоном вы расследуете загадочное убийство.", basedOn: "По мотивам произведений Артура Конан Дойла", players: "2-5 человек", difficulty: "Средний", difficultyEn: "medium", image: "фото/sherlok.png", theme: "Детектив / Викторианский Лондон", story: "На Бейкер-стрит произошло убийство. Скотленд-Ярд в тупике. Шерлок Холмс просит вашей помощи. Вам предстоит осмотреть место преступления, допросить свидетелей и собрать улики.", features: ["Атмосфера XIX века", "Дедуктивные загадки", "Интерактивные улики"] },
    { id: "hogwarts", name: "Тайная комната Хогвартса", type: "Квест-анимация", typeEn: "kids", status: "open", rating: 5.0, price: 3000, priceStr: "от 3000₽", desc: "Магия, заклинания и факультеты", duration: "90 минут", fullDesc: "Погрузитесь в мир Гарри Поттера! Вы — новые ученики Хогвартса.", basedOn: "По вселенной Гарри Поттера", players: "3-6 человек", difficulty: "Средний", difficultyEn: "medium", image: "фото/hog.png", theme: "Фэнтези / Магия", story: "Вы получили письмо из Хогвартса. Но в школе творится что-то странное: студенты исчезают, а коридоры полны тайн. Профессор Дамблдор просит вас найти Тайную комнату и разгадать загадку Слизерина.", features: ["Магические атрибуты", "Зельеварение", "Загадки по вселенной", "Костюмы факультетов"] },
    { id: "huggy", name: "Хаги Ваги", type: "Квест-анимация", typeEn: "kids", status: "open", rating: 4.8, price: 2100, priceStr: "от 2100₽", desc: "Детский хоррор с монстриками", duration: "50 минут", fullDesc: "Добро пожаловать на фабрику игрушек! Хаги Ваги и другие монстры устроили веселые испытания.", basedOn: "По мотивам игры Poppy Playtime", players: "2-4 человека", difficulty: "Лёгкий", difficultyEn: "easy", image: "фото/hagi.png", theme: "Детский хоррор / Приключение", story: "Фабрика игрушек Playtime Co. закрылась много лет назад, но игрушки ожили. Хаги Ваги приглашает вас поиграть. Но его игры не всегда безопасны. Пройдите испытания, решите головоломки и найдите выход.", features: ["Живые игрушки", "Яркие декорации", "Детские загадки", "Безопасный хоррор"] },
    { id: "wednesday", name: "Уэнсдей", type: "Квест-анимация", typeEn: "kids", status: "open", rating: 4.9, price: 2600, priceStr: "от 2600₽", desc: "Готическая загадка от Уэнсдей", duration: "65 минут", fullDesc: "Академия Невермор. Уэнсдей Аддамс просит вас помочь раскрыть тайну.", basedOn: "По сериалу «Уэнсдей»", players: "2-5 человек", difficulty: "Средний", difficultyEn: "medium", image: "фото/wend.png", theme: "Готический детектив", story: "В академии Невермор происходит нечто странное. Уэнсдей подозревает, что за этим стоит древнее проклятие. Она просит вашей помощи. Вам предстоит исследовать тайные комнаты и расшифровать записи в дневниках.", features: ["Готическая атмосфера", "Химические опыты", "Танцевальный батл", "Интерактивные загадки"] },
    { id: "stranger-things", name: "Обратная сторона", type: "Квест", typeEn: "horror", status: "open", rating: 4.9, price: 2900, priceStr: "от 2900₽", desc: "Погружение в мир обратной стороны", duration: "75 минут", fullDesc: "Вдохновлённый сериалом «Очень странные дела». Исследуйте заброшенную лабораторию.", basedOn: "По мотивам сериала «Очень странные дела»", players: "2-6 человек", difficulty: "Средний", difficultyEn: "medium", image: "фото/obrt.jpeg", theme: "Мистика / Научная фантастика", story: "Хокинс, 1985 год. В лаборатории пропали учёные. Вы отправляетесь туда, чтобы выяснить правду, но оказываетесь в ловушке. Вокруг — странные существа, порталы и измерения.", features: ["Атмосфера 80-х", "Элементы научной фантастики", "Живые актёры", "Монстры из измерений"] },
    { id: "pirates", name: "Проклятие Чёрной жемчужины", type: "Квест-анимация", typeEn: "kids", status: "open", rating: 4.7, price: 2800, priceStr: "от 2800₽", desc: "Пиратское приключение с поиском сокровищ", duration: "70 минут", fullDesc: "Йо-хо-хо! Вы — команда пиратов на поисках легендарного клада.", basedOn: "По мотивам фильма «Пираты Карибского моря»", players: "2-6 человек", difficulty: "Средний", difficultyEn: "medium", image: "фото/prokl.jpg", theme: "Приключения / Пираты", story: "Капитан Джек Воробей потерял свою карту сокровищ. Он нанимает вас, чтобы найти Чёрную жемчужину и снять проклятие. Вас ждут морские битвы, загадки древних пиратов и встреча с призраками.", features: ["Пиратские костюмы", "Карты и компасы", "Приключенческие загадки", "Командный дух"] },
    { id: "matrix", name: "Матрица: Выбор", type: "VR-квест", typeEn: "vr", status: "open", rating: 4.9, price: 3200, priceStr: "от 3200₽", desc: "Погружение в мир Матрицы с полным VR-опытом", duration: "65 минут", fullDesc: "Красная или синяя таблетка? Вы попали в Матрицу.", basedOn: "По вселенной Матрицы", players: "2-4 человека", difficulty: "Высокий", difficultyEn: "hard", image: "фото/matrix.jpg", theme: "Киберпанк / Философская фантастика", story: "Вы — избранный. Агенты Смиты знают о вас. Вы должны сбежать из Матрицы, уклоняясь от пуль и взламывая код реальности. Сможете ли вы принять красную таблетку и увидеть правду?", features: ["Полное VR-погружение", "Slow-motion эффект", "Борьба с агентами", "Философские загадки"] },
    { id: "zombie", name: "Зомби-апокалипсис", type: "Квест", typeEn: "horror", status: "open", rating: 4.8, price: 2700, priceStr: "от 2700₽", desc: "Выживание в мире зомби", duration: "60 минут", fullDesc: "Вирус вышел из-под контроля. Найдите вакцину и выберитесь.", basedOn: "По мотивам фильмов про зомби", players: "2-5 человек", difficulty: "Средний", difficultyEn: "medium", image: "фото/zombi.jpeg", theme: "Постапокалипсис / Хоррор", story: "Вирус Z-19 распространился по городу. Вы — последние выжившие, укрывшиеся в лаборатории. Нужно найти образец вакцины и выбраться на крышу, где вас ждёт вертолёт. Но зомби уже рядом.", features: ["Реалистичный грим", "Живые зомби", "Тактическое выживание", "Атмосфера апокалипсиса"] },
    { id: "inception", name: "Начало", type: "Квест", typeEn: "logic", status: "open", rating: 4.9, price: 3100, priceStr: "от 3100₽", desc: "Внедрение в сон", duration: "80 минут", fullDesc: "Внедритесь в сон миллиардера и украдите секретные данные.", basedOn: "По мотивам фильма «Начало»", players: "2-5 человек", difficulty: "Высокий", difficultyEn: "hard", image: "фото/start.jpg", theme: "Фантастика / Психологический триллер", story: "Вы — экстракторы, способные проникать в сны. Ваша цель — внедрить идею в подсознание бизнесмена, чтобы разрушить его империю. Но сны имеют несколько уровней, а проекции будут мешать.", features: ["Многоуровневые загадки", "Эффект гравитации", "Проекции сознания", "Психологические ловушки"] },
    { id: "back-to-future", name: "Назад в будущее", type: "Квест-анимация", typeEn: "kids", status: "open", rating: 4.8, price: 2600, priceStr: "от 2600₽", desc: "Путешествие во времени на DeLorean", duration: "70 минут", fullDesc: "Док Браун нуждается в вашей помощи! Почините машину времени.", basedOn: "По мотивам фильма «Назад в будущее»", players: "2-5 человек", difficulty: "Средний", difficultyEn: "medium", image: "фото/back.jpg", theme: "Научная фантастика / Комедия", story: "Док Браун застрял в 1955 году, а его DeLorean сломан. Вы должны отыскать детали, собрать 1.21 гигаватт и вернуть его в 1985 год, не нарушив временной континуум.", features: ["Машина времени", "Ностальгические загадки", "Юмор", "Приключение во времени"] },
    { id: "jumanji", name: "Джуманджи", type: "Квест-анимация", typeEn: "kids", status: "open", rating: 4.9, price: 2900, priceStr: "от 2900₽", desc: "Приключение в джунглях", duration: "75 минут", fullDesc: "Вы нашли загадочную настольную игру и теперь вы внутри неё.", basedOn: "По мотивам фильма «Джуманджи»", players: "2-6 человек", difficulty: "Средний", difficultyEn: "medium", image: "фото/jumangi.jpg", theme: "Приключения / Фэнтези", story: "Вы наткнулись на старую настольную игру «Джуманджи». Бросаете кубик — и вас затягивает в джунгли. Чтобы вернуться домой, нужно пройти все испытания, сразиться с хищниками и найти сокровище.", features: ["Интерактивные испытания", "Живые джунгли", "Звери и ловушки", "Командное приключение"] },
    { id: "saw", name: "Пила: Комната страха", type: "Квест", typeEn: "horror", status: "open", rating: 5.0, price: 3400, priceStr: "от 3400₽", desc: "Самый страшный квест по мотивам Пилы", duration: "90 минут", fullDesc: "Вы проснулись в комнате, где за вами наблюдает Конструктор.", basedOn: "По мотивам серии фильмов «Пила»", players: "2-4 человека", difficulty: "Экстремальный", difficultyEn: "hard", image: "фото/pila.jpg", theme: "Психологический хоррор / Триллер", story: "Вы просыпаетесь в заброшенной ванной. Запись на диктофоне сообщает: «Вы должны пройти мои испытания, чтобы жить. Решайте загадки, жертвуйте или ищите выход». Каждая комната — ловушка.", features: ["Экстремальные загадки", "Моральный выбор", "Атмосфера Пилы", "Ловушки"] }
];
...
const newsData = [
    ...
    },
    {
        ...
        image: "https://picsum.photos/id/68/600/400",
        category: "Награды",
